...
@section('content')
    <div class="container d-flex justity-content-center mt-3">
        <div class="w-75">
            <h1>ショッピングカート</h1>
                    ...
                    <div class="col-md-2 mt-2">
                        <a href="{{ route('products.show', $product->id) }}">
                            @if ($product->options->image)
                                <img src="{{ asset($product->options->image) }}" alt="" class="img-fluid w-100">
                            @else
            ...
            <form method="post" action="{{route('carts.destroy')}}" class="d-flex justify-content-end mt-3">
                ...
                @if ($total > 0)
                    <div class="btn laravelmart-submit-button" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div>
                @else
                    <div class="btn laravelmart-submit-button disabled" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div>
                @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn laravelmart-favorite-button border-dark text-dark" data-bs-dismiss="modal">閉じる</button>
                                <button type="submit" class="btn laravelmart-submit-button">購入</button>
                            </div>
                        </div>
                    </div>
                </div>
